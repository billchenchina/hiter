...
//                                    mySubject.save();
    ...
    private MySubject getMyExam(int i, int j, String course, String info){
        ...
        mySubject.setClassroom("无");
        mySubject.setWeeks(getWeeks(infos[1], false, false));
...
//        mySubject.setInfo(info.split("周")[0] + "周");
        ...
        mySubject.setClassroom(infos[2].replace("周",""));
        mySubject.setWeeks(getWeeks(infos[1], isEven, isOdd));
    ...
    private MySubject getMySubject(int i, int j, String course, String info, String room){
        ...
        mySubject.setClassroom(room);
        mySubject.setWeeks(weekList);
        return mySubject;
    }
